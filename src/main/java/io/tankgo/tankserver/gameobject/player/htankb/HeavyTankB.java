...
public class HeavyTankB extends BasePlayer {
    ...
    public void init(GameUser gameUser, World world, double worldTime) {
        ...
        HeavyTankBBorn heavyTankBBorn = new HeavyTankBBorn(this);
        setGameObjectState(heavyTankBBorn);
        this.world = world;
        controller = new Body();
        ...
        player.addFixture(Geometry.createRectangle(0.6, 0.6),
                200,
                0.2,
                0.8);
    ...
    public List<FireVec> getFireVecs(){
        ...
        double r1=r-Math.PI/2;
        double x1 = x+Math.cos(r1)*0.1;
        double y1 = y+Math.sin(r1)*0.1;
        FireVec fireVec1=new FireVec(x1,y1,r,0.45,6);
        double r2=r+Math.PI/2;
        double x2 = x+Math.cos(r2)*0.1;
        double y2 = y+Math.sin(r2)*0.1;
        FireVec fireVec2=new FireVec(x2,y2,r,0.45,6);
        return Arrays.asList(fireVec1,fireVec2);
    }
